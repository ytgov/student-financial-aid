export const en = {
  system: {
    name: "Student Financial Assistance Portal",
  },
  nav: {
    home: "Home",
    about: "About",
  ...
  eligibility: {
    ...
    designated_institution: {
      ...
      notes:
        'If your school is not listed, contact our office by email at <a href="mailto:sfa@yukon.ca">sfa@yukon.ca</a> and provide the name of your school, schools website, and your schools email address.',
      institutions: [
        "Yukon College",
        "Alcan Air",
        "McMaster University",
