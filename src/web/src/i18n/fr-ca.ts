export const fr = {
  system: {
    name: "Portail de l’aide financière aux étudiants",
  },
  nav: {
    home: "Accueil",
    about: "À propos",
  ...
  eligibility: {
    ...
    residency: {
      ...
      drivers_lisence_another_jurisdiction: "Êtes-vous titulaire d’un permis de conduire délivré ailleurs qu’au Yukon?",
    },
    program: {
      title: "Programme",
