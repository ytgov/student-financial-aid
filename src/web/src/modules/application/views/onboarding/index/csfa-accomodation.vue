              ...
              <tbody v-for="(item, key) in accomodations">
                ...
                <tr>
                  <td colspan="6" class="checkboxes">
                    <div>
                      <label
                        ><input type="radio" value="Living at Parents" v-model="accomodations[key].values.living" />
                        Living at Parents</label
                      >
                      <label
                        ><input type="radio" value="Living on Own" v-model="accomodations[key].values.living" /> Living
                        on Own</label
                      >
